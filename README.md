...
- `@State` - используется только внутри View. Всегда делайте приватным
- `@Binding` - используется как внутри View, так и снаружи
- `@StateObject` - используется только внутри View. Жизненный цикл равен жизненному циклу View. Всегда делайте приватным
